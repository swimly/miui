import { r as registerInstance$1, c as createEvent$1, h as h$1, H as Host$1, g as getElement$1 } from './index-e5ececff.js';

const NAMESPACE = 'miui';
const BUILD = /* miui */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, cloneNodeFix: false, cmpDidLoad: true, cmpDidRender: true, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: true, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: true, devTools: true, disconnectedCallback: false, dynamicImportShim: true, element: false, event: true, hasRenderFn: true, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: true, lifecycleDOMEvents: false, member: true, method: true, mode: false, observeAttribute: true, profile: true, prop: true, propBoolean: true, propMutable: false, propNumber: true, propString: true, reflect: false, safari10: true, scoped: false, scriptDataOpts: true, shadowDelegatesFocus: false, shadowDom: true, shadowDomShim: true, slot: true, slotChildNodesFix: false, slotRelocation: true, state: false, style: true, svg: true, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: true, vdomClass: true, vdomFunctional: false, vdomKey: true, vdomListener: true, vdomPropOrAttr: true, vdomRef: true, vdomRender: true, vdomStyle: true, vdomText: true, vdomXlink: true, watchCallback: true };
    ...
    if ((BUILD.lazyLoad || BUILD.hydrateServerSide || BUILD.style) && (hostRef.$flags$ & 32 /* hasInitializedComponent */) === 0) {
        ...
        if (BUILD.style && !styles.has(scopeId) && Cstr.style) {
            ...
            if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                style = await __sc_import_miui('./shadow-css-7f9c6860.js').then(m => m.scopeCss(style, scopeId, false));
            }
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_miui(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-8a9bfe22.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_miui(/* webpackChunkName: "polyfills-dom" */ './dom-24a54a40.js').then(() => opts);
        }
    }
...
class HcButton {
    constructor(hostRef) {
        ...
        this.icon = '';
        this.vclick = createEvent$1(this, "vclick", 7);
    }
    loadingHandle(v) {
    ...
    render() {
        return (h$1(Host$1, { onclick: this.onClick.bind(this) }, h$1("hc-ripple", { mask: !this.ripple, color: this.rippleColor }, h$1("div", { class: "button", style: {
                backgroundColor: this.backgroundColor,
                color: this.color
            } }, h$1("span", { class: "line", style: {
                borderColor: this.borderColor
            } }), h$1("hc-icon", { name: this.icon }), h$1("span", { class: "label" }, h$1("slot", null, this.label))))));
    }
    onClick(e) {
        if (!this.disabled) {
            this.vclick.emit(e);
