...
class HcInfinite {
    ...
    render() {
        return (h(Host, null, h("div", { id: "mescroll", class: "mescroll" }, h("div", null, h("slot", null)))));
    }
    get el() { return getElement(this); }
}
HcInfinite.style = hcInfiniteCss;

export { HcInfinite as hc_infinite };
