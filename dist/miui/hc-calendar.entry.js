...
class HcCalendar {
    ...
    render() {
        ...
        let dom;
        if (this.type === 'week') {
            dom = (h("hc-calendar-content", Object.assign({}, { width: this.el.offsetWidth }), this.data.map((week) => (h("hc-calendar-week", null, week.days.map((day) => (h("hc-calendar-day", Object.assign({}, { year: day.year, month: day.month, day: day.day, week: day.week }), day.day))))))));
        }
        else {
            dom = (h("hc-calendar-content", Object.assign({}, { width: this.el.offsetWidth }), this.data.map((month) => (h("hc-calendar-month", null, month.days.map((week) => (h("hc-calendar-week", null, week.map((day) => (h("hc-calendar-day", Object.assign({}, { year: day.year, month: day.month, day: day.day, week: day.week }), day.day)))))))))));
        }
        return (h(Host, null, h("slot", null, dom)));
    }
