...
const hcSignatureCss = ":host{display:block;background:var(--background-color-dark)}";
...
class HcSelect {
    ...
    render() {
        return (h(Host, null, h("canvas", { id: "canvas" }), h("slot", null)));
    }
    async fetchData() {
        return this.data;
    }
...
HcSelect.style = hcSignatureCss;

export { HcSelect as hc_signature };
